...
public class FileInputBufferExample {
    private static final String FILE_NAME =
            "/Users/kblyumkin/Projects/SourceIt/resources/someBigFile.mp3";
    ...
    public static void main(String[] args) {
        ...
        InputStream is = null;
        try {
            for (int bufferSize = 1; bufferSize <= 32 * 1024; bufferSize = bufferSize * 2) {
                long startTime = System.currentTimeMillis();
                is = new BufferedInputStream(
                        new FileInputStream(file), 32 * 1024);
